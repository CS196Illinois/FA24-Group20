        ...
        <div>
            ...
            <div className={classes.gridLayout}>
                <div>
                    ...
                    <p className={classes.textContent3L}>
                        ...
                        began programming in ninth grade, motivated by<br></br>  
                        a desire to customize Minecraft through mod<br></br>  
            ...
            <div className={classes.gridLayout}>
                <div>
                    ...
                    <p className={classes.textContent3L}>
                        Hey, my name is Maryana Cholach and I am currently<br></br>
                        ...
                        see if this could be a possible area I could get<br></br>
            ...
            <div className={classes.gridLayout}>
                ...
                <div>
                    ...
                    <p className={classes.textContent3R}>
                        Hi! My name is Dhanish Natarajan, and I'm currently<br></br> 
                        a Sophomore, majoring in Statistics and CS. I am so<br></br> 
                        grateful to be a PM for such an amazing & motivated<br></br> 
                        team! I initially fell in love with CS by getting into<br></br> 
                        game development. I also love the inter-disciplinary<br></br> 
                        aspect of CS & data science, particularly in relation<br></br> 
                        with environmental sustainability. Over the years, I<br></br> 
                        realized that I simply love creating things that make<br></br> 
                        an impact and working with others, which is my<br></br> 
                        favorite part of CS. I hope to gain more work<br></br>
                        experience with CS, build cool projects, and join the<br></br>
